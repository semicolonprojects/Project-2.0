...
{{-- Data Supplier Curah --}}
<div class="absolute ml-32 mt-28">
  <div class="grid grid-flow-col gap-[670px] ">
    <h5 class="text-3xl font-bold tracking-tight text-gray-900">Data Supplier Curah</h5>
    ...
    <table class="w-[1130px] text-[14px] text-left text-gray-500">
        ...
        <tbody>
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                ...
                <td class="px-4 py-4">
                    <button class="bg-[#513300] text-white font-bold py-1 px-3 rounded-[22px]">
                        PENDUKUNG
                    </button>
                </td>
                <td class="px-6 py-4">
            ...
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                ...
                <td class="px-9 py-4">
                    <button class="bg-[#FFC700] text-white font-bold py-1 px-3 rounded-[22px]">
                        MADU
                    </button>
                </td>
                <td class="px-6 py-4">
            ...
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                ...
                <td class="px-8 py-4">
                    <button class="bg-[#505050] text-white font-bold py-1 px-3 rounded-[22px]">
                        OTHERS
                    </button>
                </td>
                <td class="px-6 py-4">
