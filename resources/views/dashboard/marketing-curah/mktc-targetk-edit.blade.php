...
<section class="bg-white shadow-[4px_8px_8px_rgba(0,0,0,0.5)] w-[70%] rounded-[22px] ml-52 mt-10 dark:bg-gray-900">
  <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
      ...
      <form action="{{ route('targetKaryawanC.update', ['targetKaryawanC' => $targetKaryawanCurah->id]) }}" method="POST">
        @csrf
        @method('put')
          <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
              ...
              <div class="w-full">
                  ...
                  <input type="number" name="target" id="" value="{{ $targetKaryawanCurah->target }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Ex: 10.000.000" required="">
              </div>
              <div>
                ...
                <div class="relative max-w-sm">
                  ...
                  <input type="date" name="deadline_target" id="" value="{{ $targetKaryawanCurah->deadline_target }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-background focus:border-background block w-full pl-10 p-2.5 " placeholder="Select date">
                </div> 
            </div>
          </div>
            <div>
