    ...
    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
        ...
        <tbody>
            ...
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                ...
                <td class="px-6 py-4">
                    {{ $produk->produkCurah->nama_barang }}
                </td>
                <td class="px-6 py-4">
                ...
                <td class="px-6 py-4">
                    ...
                    <form action="{{ route('in_out_curah.destroy', ['in_out_curah' => $produk->id]) }}" method="post"
                        class='inline'>
...
<div id="defaultModalEdit{{ $modal->id }}" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative p-4 w-full max-w-2xl h-full md:h-auto">
        ...
        <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
            ...
            <!-- Modal body -->
            <form action="{{ route('in_out_curah.update', ['in_out_curah'=>$modal->id]) }}" method="POST">
                @csrf
                @method('put')
                <div class="grid gap-4 mb-4 sm:grid-cols-2">
                    <div>
                        ...
                        <input type="text"
                            ...
                            value="{{ $modal->produkCurah->nama_barang }}">
