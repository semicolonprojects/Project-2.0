...
<body>
    ...
    <div id="separator" class="">
        <div class="">
           @if($invoice->seller->name)
           <p class="seller-name sm">
       ...
       <div>
           ...
           <p class="seller-custom-field smc">
               {{ ucfirst($key) }}: {{ $value }}
           </p>
           @endforeach
       </div>  
    ...
    <table class="table">
        <tbody>
            <tr>
                ...
                <th class="border-0 pl-0 text-right">
                    <div class="sm">
                        <p><strong>Invoice No. </strong> <strong>{{ $invoice->getSerialNumber() }}</strong></p>
                    </div>
                    <div class="smc">
                        <p>{{ __('invoices::invoice.date') }}: {{ $invoice->getDate() }}</p>
                    </div>
    ...
    <p>
        ...
        Send to bank <br>
        BCA : 8161576841 an Mentari Puji Rahayu <br>
        Mandiri : 1430017572783 an Mentari Puji Rahayu <br>
        BRI : 042901029308508 an Andoni Pridatama <br>
    </p>
    <p>
        Terms <br>
        Pembayaran maksimal 1x24 jam Setelah Invoice Dan Resi Terbit
    </p>
    {{-- <p>
